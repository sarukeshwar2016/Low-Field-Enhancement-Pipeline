...
Fixes previous issues with affine alignment and SNR constraint enforcement.
...
============================================================
Pipeline:
LF â†’ N4 â†’ Intensity Std â†’ Wiener â†’ Histogram Match â†’ Smooth â†’ Contrast â†’ Final
