...
simulate_batch_9_100.py
=======================
Batch low-field simulation runner for patients 9-100.

Uses dicom_to_lf_sim physics model to generate LF simulations
from pre-converted NIfTI high-field inputs (skipping DICOM step).
