...
run_batch_spine_stable.py
=========================
Spine-optimized stable batch runner for lumbar MRI enhancement.

Tuned parameters for lumbar spine anatomy and clinical scan protocols.
...
============================================================
Pipeline:
LF â†’ N4 â†’ Intensity Std â†’ Wiener â†’ Smooth â†’ Micro Contrast â†’ Final
...
def process_patient(lf_path, hf_path):
    ...
    # ðŸ§ª RESAMPLE HF TO LF GRID (FOR METRICS)
